...
public class GateHintNPC : MonoBehaviour
{
    //定义NPC对话数据
    private string[] mData = { "This is the reward for your to supply blood", 
    "There is only one person in front of the three guards who is telling the truth. ",
    "You need to judge which road is correct according to their words.", 
    "...and the box may help you jump over the wall." };
    //当前对话索引
    private int index = 0;
    //用于显示对话的GUI Text
    public Text mText;
