...
public class ColorNPC : MonoBehaviour
{
    ...
    //定义NPC对话数据
    private string[] mData = { "I have met a girl.", "I fell in love with her.","We are both painters.","Her favorite color is red.", "She said red represented Passion and hope.","So I will get all red things for her." };
    //当前对话索引
    private int index = 0;
    //用于显示对话的GUI Text
    public Text mText;
