...
public class LastFoxNPC : MonoBehaviour
{

    //定义NPC对话数据
    private string[] mData = { "Do you want to leave here?", "As long as you find the right path, you can.", "Otherwise you will re-experience all this." };
    //当前对话索引
    private int index = 0;
    //用于显示对话的GUI Text
    public Text mText;
