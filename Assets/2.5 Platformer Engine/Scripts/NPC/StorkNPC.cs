...
public class StorkNPC : MonoBehaviour
{

    //定义NPC对话数据
    private string[] mData ={"...Why are you here?","I used to be an adventurer like you,","then I took an arrow in the knee..."};
    //当前对话索引
    private int index = 0;
    //用于显示对话的GUI Text
    public Text mText;
